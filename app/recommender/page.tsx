        ...
        <header className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="space-y-2">
              ...
              <h1 className="text-3xl font-semibold tracking-tight md:text-4xl">Product recommender by similarity</h1>
              <p className="max-w-3xl text-base leading-relaxed text-muted">
                Semantic search over your catalog and item-to-item recommendations powered by embeddings.
              </p>
            </div>
